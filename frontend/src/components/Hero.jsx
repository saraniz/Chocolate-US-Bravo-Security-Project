          ...
          <div className="container mx-auto px-4">
            <div className="w-full flex flex-col items-center text-center space-y-16">
              <div className="max-w-3xl">
                <h1 className="text-3xl md:text-6xl font-bold text-amber-900 leading-tight mb-6">
              ...
              <div className="w-full max-w-5xl relative">
                ...
                >
                            ...
                            >
                              ...
                              <div className="relative group">
                                <img
                                  src={deal.image}
                                  alt={deal.title}
                                  className="w-[200px] h-[200px] md:w-[300px] md:h-[300px] object-contain rounded-xl transform transition-transform duration-300"
                                />
                              ...
                              <div className="flex flex-col justify-center space-y-5 text-center md:text-left">
                                <h3 className="text-2xl md:text-3xl font-bold text-amber-900">{deal.title}</h3>
                                <p className="text-sm md:text-lg text-gray-600 leading-relaxed">{deal.description}</p>
                                <div className="md:flex items-center justify-center md:justify-start gap-5">
                                  <div className="md:text-3xl font-semibold text-amber-800">{deal.price}</div>
                                  <div className="text-lg font-bold mt-2 md:mt-0 text-red-500 bg-red-50 px-5 py-2 rounded-full shadow-sm">
                                    {deal.discount}
                                  </div>
                                </div>
                              </div>
                  ...
                  <div className="absolute left-5 right-5 md:-left-16 md:-right-16 top-1/2 -translate-y-1/2 flex justify-between pointer-events-none">
