    ...
    <>
      ...
      >
        <nav className="flex flex-col px-4 py-4 space-y-4">
          ...
          <div className="flex pt-4 space-x-3 items-center border-t border-neutral-200">
            ...
            {user ? (
              <div className="relative">
                ...
                {isDropdownOpenmobile && (
                  <div className="absolute w-30 bg-black z-40 right-0 p-2 rounded flex flex-col space-y-2 text-white text-lg">
